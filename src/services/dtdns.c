...
#define DDNS_NAME "dtdns"
#define DDNS_HOST "www.dtdns.com"
#define DDNS_PORT 80
...
static struct {
	...
	{ .propcode = " now points to ",
          .propcode_info = "Record has been updated successfully.",
          .code = up_success,
        },
	{ .propcode = "No hostname to update was supplied.",
          .propcode_info = "You failed to provide a record ID to update.",
          .code = up_syntax_error,
        },
	{ .propcode = "No password was supplied.",
          .propcode_info = "User authentication failed (no password given).",
          .code = up_account_loginpass_error,
        },
	{ .propcode = "The hostname you supplied is not valid.",
          .propcode_info = "You are not the owner of the record you are trying to update.",
          .code = up_account_hostname_error,
        },
	{ .propcode = "The password you supplied is not valid.",
          .propcode_info = "User authentication failed (wrong password given).",
          .code = up_account_loginpass_error,
        },
	{ .propcode = "Illegal character in IP.",
          .propcode_info = "You provided an invalid IP address (or didn't provide one at all).",
          .code = up_syntax_error,
        },
	{ .propcode = "This account has not yet been activated.",
          .propcode_info = "User authentication failed (account not yet activated).",
          .code = up_account_loginpass_error,
        },
	{ .propcode = "Administration has disabled this account.",
          .propcode_info = "User authentication failed (account disabled by administration).",
          .code = up_account_loginpass_error,
        },
	{ NULL,	NULL, 0, }
};
